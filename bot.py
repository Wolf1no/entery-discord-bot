...
if not TWITCH_CLIENT_ID or not TWITCH_CLIENT_SECRET or not TWITCH_ACCESS_TOKEN:
...
try:
    ...
    twitch.set_user_authentication(TWITCH_ACCESS_TOKEN, ["channel:read:vips", "moderator:read:chatters"], "")
